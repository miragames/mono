...
{
    uint8_t buf1[] = { 0xf3, 0xbc, 0x64, 0x7d, 0x12, 0x05, 0xbf, 0x1a, 0x00, 0x6e, 0x28, 0xfd, 0x08, 0x1f, 0xfa, 0xbb };
    uint8_t buf2[]  = { 0xf4, 0xc2, 0x04, 0x87, 0xe0, 0xd2, 0x18, 0x8b, 0xfa, 0x1d, 0x7d, 0x82, 0x4d, 0xa5, 0x70, 0x95 };
    ...
    while (1)
    {
        ...
        func_9d2c4c689(outdata, indata, 16, buf1, buf2);
